    ...
    <section className="section content">
      <div className="container">
        ...
        <p>
          ...
          . But unfortunately it didn't work for anything but trivial queries. As soon as CTEs or other Init Plans were
          present, the graphs would break due to child node times exceeding the total duration of their parents because
          PostgreSQL double counts node execution times under many circumstances.
        </p>
        <p>
          After that the project lingered in the back of my mind, and it wasn't until late 2019 that I had the time and
          inspiration that lead to a <PageLink page={QuirkCorrection} text="breakthrough" anchor="CTEs" /> in correcting
          the node times. However, once I looked at some more complicated queries again, it quickly became clear that
          flame graphs alone were not sufficient. They are great at highlighting the expensive parts of a query, but
          they fail to reveal the overall plan structure due to fast nodes getting effectively hidden by the
          visualization.
        </p>
        <p>
          However, the time correction algorithms I came up with turned out to be useful beyond flame graphs, and no
          existing tool seemed to implement them. So I decided to build a unique tool that provides multiple
          visualizations based on these new algorithms and heuristics. The result is FlameExplain and I hope you find it
          useful : ).
        </p>
        <Heading level={2}>Security & Privacy</Heading>
        <p>
          FlameExplain is a JavaScript application that runs in your browser and never sends your data to another
          computer. This should make it sufficiently secure for most use cases, including optimizing query plans that
          may contain confidential information.
        </p>
        <p>
          Additionally FlameExplain is <a href="https://github.com/felixge/flame-explain">open source</a>, so you can
          study the code, create your own build, and run it on a machine without network access.
        </p>
        <Heading level={2}>Community & Support</Heading>
        <p>
          Please use <a href="https://github.com/felixge/flame-explain/issues">GitHub Issues</a> to report bugs, request
        ...
        <p>
          Additionally there are many smaller projects and transitive dependencies that are not listed here. If you're
          the author of one of them and want to be listed, just let me know.
        </p>
