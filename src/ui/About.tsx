...
export default function About() {
  return <section className="section content">
    <div className="container">
      ...
      <p>
        After that the project lingered in the back of my mind, and it wasn't until late 2019 that I had the time and inspiration that lead to a breakthrough in adjusting the node times. However, once I looked at some more complicated queries again, it quickly became clear that flame graphs alone were not sufficient. They are great at highlighting the expensive parts of a query, but they fail to reveal the overall plan structure due to fast nodes getting effectively hidden by the visualization.
      </p>
      <p>
        However, the time adjustment algorithms I came up with turned out to be useful beyond flame graphs, and no existing tool seemed to implement them. So I decided to build unique a tool that provides multiple visualizations based on these new algorithms and heuristics. The result is FlameExplain and I hope you find it useful : ).
      </p>
