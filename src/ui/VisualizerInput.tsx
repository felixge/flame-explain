    ...
    return (
        <div>
            ...
            <div className="field content">
                ...
                <p>
                    <FontAwesomeIcon icon={faLock} /> FlameExplain runs in your browser and never sends your data to
                    another computer, see <Link to="/about#Security-and-Privacy">Security & Privacy</Link>.
                </p>
            </div>
