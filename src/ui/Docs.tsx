    ...
    <div className="container">
      <div className="columns">
        ...
        <div className="column">
          <Switch>
            {sections.map(section => section.pages.map(page => {
              const url = pageURL(page);
              return <Route key={url} path={url} exact={true}>

                <nav className="breadcrumb" aria-label="breadcrumbs">
                  <ul>
                    <li><a href={pageURL(GettingStarted)}>Docs</a></li>
                    <li className="is-active"><a href="# ">{section.name}</a></li>
                    <li className="is-active"><a href={url} aria-current="page">{page.name}</a></li>
                  </ul>
                </nav>
