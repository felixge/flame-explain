...
const page: Page = {
  ...
  page: () => (
    <React.Fragment>
      ...
      <p>
        After learning the basics, you wonder about why you should prefer a tool like FlameExplain over directly working
        with the text output format, or what makes FlameExplain better than similar tools.
      </p>
      ...
      <p>
        The second reason to use FlameExplain is the <PageLink page={Flamegraph} /> visualization. It offers a uniquely
        powerful way to quickly understand the bottlenecks of your query and what might cause them. It works especially
        well for huge queries with many nodes.
      </p>
      ...
      <p>
        ...
        . However, customizable columns, color highlighting, and various other UX enhancements make it more useful than
        ever.
      </p>
      <p></p>
    </React.Fragment>
