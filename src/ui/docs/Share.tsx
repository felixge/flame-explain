...
const page: Page = {
  ...
  page: () => <React.Fragment>
    ...
    <p>From there you can either directly copy and paste the <strong>Share JSON</strong> to a colleague, or paste it on GitHub and get direct URL for it.</p>
    <p>The <strong>Share JSON</strong> includes your current {shareElements}.</p>
  </React.Fragment>
};
