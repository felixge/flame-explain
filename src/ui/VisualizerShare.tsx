...
export default function VisualizerShare(p: Props) {
    ...
    switch (tab) {
        case "json":
            tabElement = (
                <React.Fragment>
                    <p>FlameExplain runs in your browser and never sends your data to another computer.</p>
                    <p>
                        However, you can copy the JSON below and share it via any channel you trust. The JSON contains
                        your current {shareElements} and can be pasted into the Input tab as if it was a regular JSON
                        plan.
                    </p>
                    <p></p>
                    <div className="field">
            ...
            tabElement = (
                <React.Fragment>
                    <div className="content">
                        <p>
                            If you want to share your current {shareElements} as a URL link and trust GitHub with it,
                            then&nbsp;{" "}
                            <Clipboard component="a" button-href="#" data-clipboard-text={shareText}>
                                <span className="icon is-small">
                                    <FontAwesomeIcon icon={faCopy} />
                                </span>
                    ...
                    <div className="columns">
                        ...
                        <div className="column is-expanded">
                            <input ref={gistUrlInput} value={flameURL} readOnly className="input" type="text" />
                        </div>
                    </div>
                </React.Fragment>
            )
